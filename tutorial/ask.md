帮我把旧文档 tutorial/old_api/SUMMARY.md 转换为新文档 tutorial/cn/api/_config.yaml，先只转换 属性操作 的内容

将 tutorial/old_api/props 目录下的所有文件转换为新文档 tutorial/cn/api/props 目录下的文件，并优化润色相关描述
