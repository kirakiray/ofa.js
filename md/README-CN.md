...
```html
<script src="https://cdn.jsdelivr.net/gh/ofajs/ofa.js@4.6.20/dist/ofa.min.js"></script>
```
### 调试模式
...
```html
<script src="https://cdn.jsdelivr.net/gh/ofajs/ofa.js@4.6.20/dist/ofa.js#debug"></script>
```
...
ofa.js 采用 [MIT 协议](https://github.com/ofajs/ofa.js/blob/main/LICENSE)。