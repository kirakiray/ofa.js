...
- [home.html](templates/06-scsr/home.html): 首页 SCSR 页面，客户端直接访问时使用。
- [about.html](templates/06-scsr/about.html): 关于页 SCSR 页面。
- [app-config.js](templates/06-scsr/app-config.js): 应用配置文件。
- [public.css](templates/06-scsr/public.css): 公共样式文件。
