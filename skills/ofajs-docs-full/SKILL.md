...
- assets/02-switch/switch.html: 组件模块的定义文件，负责组件模块的逻辑和渲染。
- assets/02-switch/page.html: 使用该组件的页面模块。
- assets/02-switch/demo.html: 引用页面模块的入口文件。
...
- assets/03-todolist/page.html: Todo List 页面模块，包含列表渲染和条件渲染。
- assets/03-todolist/demo.html: 引用页面模块的入口文件。
...
- assets/04-filelist/demo.html: 引用页面模块的入口文件。
- assets/04-filelist/page.html: 入口主页面。
- assets/04-filelist/filelist.html: 文件列表组件。
- assets/04-filelist/editor.html: 文件内容查看组件。
- assets/04-filelist/data.js: 模拟数据和模拟获取数据的函数。
...
- assets/05-routing/demo.html: 入口文件，使用 o-router 和 o-app 构建单页应用。
- assets/05-routing/app-config.js: 应用配置文件，定义首页地址和页面切换动画。
- assets/05-routing/layout.html: 根布局页面，包含导航栏，通过 `<slot>` 渲染子页面。
- assets/05-routing/home.html: 首页，嵌套在 layout.html 中。
- assets/05-routing/list.html: 列表页面（一级子页面），包含二级嵌套的 Tab 切换。
- assets/05-routing/list-page1.html: 推荐商品列表（二级子页面）。
- assets/05-routing/list-page2.html: 热门商品列表（二级子页面）。
- assets/05-routing/detail.html: 详情页面，获取 URL 查询参数。
...
- assets/06-scsr/home.html: 首页 SCSR 页面，客户端直接访问时使用。
- assets/06-scsr/about.html: 关于页 SCSR 页面。
- assets/06-scsr/app-config.js: 应用配置文件。
- assets/06-scsr/public.css: 公共样式文件。
...
- assets/07-api/shadow-demo.html: 组件模块，通过 `this.shadow.$()` 访问影子节点
- assets/07-api/demo.html: 入口文件，展示外部调用组件方法
